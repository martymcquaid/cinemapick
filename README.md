...
- **Dev Server URL**: `http://127.0.0.1:5246`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/dec66884-07bf-449e-aae5-0fa25bda5b6e/preview`
- **Port**: `5246`
...
4. The dev server is accessible at `http://127.0.0.1:5246`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/dec66884-07bf-449e-aae5-0fa25bda5b6e/preview`
